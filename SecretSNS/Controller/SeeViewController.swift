...
class SeeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,LoadOKDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadDBModel.loadPartContents(roomData: roomString,FieldData: FieldData,userID: userID, completion: { docID in
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return loadDBModel.PartdataSets.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let docid = loadDBModel.PartdataSets[indexPath.row].docID
        print("データ",loadDBModel.PartdataSets)
        
        let sexData = loadDBModel.PartdataSets[indexPath.row].sexData
        let ageData = loadDBModel.PartdataSets[indexPath.row].ageData
        let userName = loadDBModel.PartdataSets[indexPath.row].userName
        ...
        cell.commentLabel.text = "\(loadDBModel.PartdataSets[indexPath.row].comment)"
        cell.countLabel.text = String(self.loadDBModel.PartdataSets[indexPath.row].likeCount)
        ...
        if (self.loadDBModel.PartdataSets[indexPath.row].likeFlagDic[userID] != nil) == true{
            
            
            let flag = self.loadDBModel.PartdataSets[indexPath.row].likeFlagDic[userID]
